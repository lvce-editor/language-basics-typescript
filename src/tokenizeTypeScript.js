...
const RE_BUILTIN_CLASS =
  /^(?:Array|Object|Promise|ArrayBuffer|URL|URLSearchParams|WebSocket|FileSystemHandle|FileSystemFileHandle|Function|StorageEvent|MessageEvent|MessageChannel|Int32Array|Boolean|String|Error|Set|RegExp|Map|WeakMap|RangeError|Date|DOMMatrixReadOnly(?!\s*:)|Headers|Response|Request|Cache|Buffer|MessagePort|FileHandle|X509Certificate|Blob|File|HTMLElement|MutationRecord|HTMLVideoElement)\b/
const RE_SET = /^Set\b/
